...
//    protected $listeners = ['refresh' => '$refresh', 'changeFilter', 'changeDateFilter' ];
    ...
    {
        return [
            Column::make(__('Member'), "patient.patientUser.email")
                ->hideIf('patient.patientUser.email')
                ->searchable(),
            Column::make(__('Member'), "doctor.doctorUser.email")
            ...
            Column::make(__('Trainer'), "doctor.doctorUser.first_name")
                ...
                ->sortable()
                ->searchable(),
            Column::make(__('Trainer Department'), "department.title")
                ->view('appointments.templates.columns.department')
                ->searchable()
                ->sortable(),
            Column::make(__('Member'), "patient_id")->hideIf(1),
            Column::make(__('Trainer'), "doctor_id")->hideIf(1),
