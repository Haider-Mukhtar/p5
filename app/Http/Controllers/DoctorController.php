...
class DoctorController extends AppBaseController
{
    ...
    public function store(CreateDoctorRequest $request)
    {
        ...
        Flash::success(__('Trainer') . ' ' . __('messages.common.saved_successfully'));
    ...
    public function update(Doctor $doctor, UpdateDoctorRequest $request)
    {
        ...
        if (empty($doctor)) {
            Flash::error(__('Trainer') . ' ' . __('messages.common.not_found'));
    ...
    public function destroy(Doctor $doctor)
    {
        ...
        if ($result || $empPayRollResult) {
            return $this->sendError(__('Trainer') . ' ' . __('messages.common.cant_be_deleted'));
        }
        $doctor->user()->delete();
        $doctor->address()->delete();
        $doctor->delete();

        return $this->sendSuccess(__('Trainer') . ' ' . __('messages.common.saved_successfully'));
    }
