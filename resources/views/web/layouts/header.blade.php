    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-1 col-4">
                ...
                <!-- <h2 class="">{{ __('My PT') }}</h2> -->
                <img src="{{ asset('web_front/images/Logo/logo.jpg') }}" alt="My PT logo" class="img-fluid logo-fix-size" />
                    <!-- <img src="{{ getLogoUrl() }}" alt="MyPT Logo" class="img-fluid" /> -->
                </a>
            </div>
