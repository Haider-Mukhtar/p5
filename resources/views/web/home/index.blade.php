            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-lg-row">
                    ...
                    <div class="col-lg-6 text-lg-end text-center">
                        <img src="{{ !empty($frontSetting['home_page_image']) ? $frontSetting['home_page_image'] : asset('web_front/images/main-banner/banner-one/Home.png') }}" alt="Home page banner" class="img-fluid" />
                    </div>
                </div>
            </div>
        </section>
                        ...
                        @foreach($frontServices  as $frontService)
                            <div class="col-xl-3 col-lg-4 col-md-6 py-lg-2 card-hover d-flex align-items-stretch">
                                <div class="card p-c-4 my-lg-2 mx-lg-1 my-md-3 my-2 flex-fill">
                                    <img src="{{ isset($frontService->icon_url) ? $frontService->icon_url : asset('web_front/images/services/medicine.png') }}" class="card-img-top img-wh mx-auto " alt="img">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 position-relative">
                        <div class="certified-doctor  text-end">
                            <img src="{{ $frontSetting['home_page_certified_doctor_image'] }}" alt="Certifired Trainers" class="img-fluid">
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        ...
                        <div class="testimonial-img">
                                <img src="{{ asset('web_front/images/Testimonials/girl.jpg') }}" alt="Testimonials" class="img-fluid" />
                                <!-- <img src="resources\assets\front\images\testimonials\g1.png" alt="" class="img-fluid"> -->
                                <!-- img src="{{ asset('web_front/images/page-banner/Testimonials.png') }}" alt="Infy Care" class="img-fluid" /> -->
                                <p class="mb-0 pt-3">
                            My Personal Trainer has been a game-changer for me. The trainers are highly qualified and provide 
                            personalized training plans that cater to my specific needs. I've seen a significant improvement in 
                            my fitness level and overall health since joining the platform.
                            </p>
                            </div>
                            <div class="testimonial-img">
                            <img src="{{ asset('web_front/images/Testimonials/man.jpg') }}" alt="Testimonials" class="img-fluid" />
                                <!-- img src="resources\assets\front\images\testimonials\g1.png" class="img-fluid" /> -->
                                <p class="mb-0 pt-3">
                                I've tried various fitness programs in the past, but nothing compares to the level of expertise and 
                            support I've received from My Personal Trainer. The community aspect of the platform keeps me motivated 
                            and the progress tracking feature helps me stay on track with my goals.
                            </p>
                            </div>
                            <div class="testimonial-img">
                            <img src="{{ asset('web_front/images/Testimonials/girl.jpg') }}" alt="Testimonials" class="img-fluid" />
                                <!-- img src="{{ asset('web_front/images/page-banner/Testimonials.png') }}" alt="Infy Care" class="img-fluid" /> -->
                                <p class="mb-0 pt-3">
                                I highly recommend My Personal Trainer to anyone looking for expert guidance and support in their fitness 
                            journey. The trainers are friendly, knowledgeable, and genuinely care about helping you reach your full potential.
                            </p>
                            </div>
                            <div class="testimonial-img">
                            <img src="{{ asset('web_front/images/Testimonials/man.jpg') }}" alt="Testimonials" class="img-fluid" />
                                <!-- img src="{{ asset('web_front/images/page-banner/Testimonials.png') }}" alt="Infy Care" class="img-fluid" /> -->
                                <p class="mb-0 pt-3">
                                Thanks to My Personal Trainer, I've achieved results I never thought were possible. The customized workout plans 
                            and nutrition advice have transformed my body and I feel healthier and more confident than ever before.
                            </p>
                            </div>
                            <div class="testimonial-img">
                            <img src="{{ asset('web_front/images/Testimonials/girl.jpg') }}" alt="Testimonials" class="img-fluid" />
                                <!-- img src="{{ asset('web_front/images/page-banner/Testimonials.png') }}" alt="Infy Care" class="img-fluid" /> -->
                                <p class="mb-0 pt-3">
                                The trainers at My Personal Trainer are the real deal. They have the experience and knowledge to create effective 
                            and challenging workouts that push me to my limits. I've never felt stronger or more motivated to continue my fitness journey.
                            </p>
                            </div>
