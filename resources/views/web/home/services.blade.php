            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 text-lg-end text-center">
                        <img src="{{ asset('web_front/images/page-banner/Services.png') }}" alt="Services banner" class="img-fluid" />
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 py-lg-2 card-hover d-flex align-items-stretch">
                            <div class="card p-c-4 my-lg-2 mx-lg-1 my-md-3 my-2 flex-fill">
                                <img src="{{ isset($frontService->icon_url) ? $frontService->icon_url : asset('web_front/images/services/Workouts.png') }}" class="card-img-top img-wh mx-auto " alt="Service Img">
