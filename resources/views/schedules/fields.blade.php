<div class="row gx-10 mb-5">
    ...
    @else
        <div class="form-group col-sm-8 mb-5">
            ...
            {{ Form::select('doctor_id',$data['doctors'], null, ['class' => 'form-select','required','id' => 'doctorId','placeholder' => __('Select Trainer Name'),'data-control' => 'select2']) }}
        </div>
    @endif
    @if(Auth::user()->hasRole('Doctor'))
        <div class="form-group col-sm-12 mb-5">
            {{ Form::label('per_patient_time', __('Per Member Time').':', ['class' => 'form-label']) }}
            <span class="required"></span>
