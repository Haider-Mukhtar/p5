...
return [
    ...
    */
    //menu.blade keys
    'roles'                   => 'Roles',
    'doctor_departments'      => 'Trainer Departments',
    'nurses'                  => 'Nurses',
    'doctors'                 => 'Trainers',
    'patients'                => 'Members',
    ...
    'settings'                => 'Settings',
    'doctors_list'            => 'Trainers List',
    'my_payrolls'             => 'My Payrolls',
    'blood_banks'             => 'Blood Banks',
    'blood_donors'            => 'Blood Donors',
    'invoices'                => 'Invoices',
    'patients_cases'          => 'Members Cases',
    'patients_case_details'   => 'Members Case Details',
    ...
    'hospital_activities'     => 'Activities',
    'advanced_payments'       => 'Advance Payments',
    'patient_admissions'      => 'Member Admissions',
    ...
    'doctor_opd_charges'      => 'Trainer OPD Charges',
    'pathology_tests'         => 'Pathology Tests',
    'expenses'                => 'Expenses',
    'income'                  => 'Income',
    'finance'                 => 'Finances',
    'issued_items'            => 'Issued Items',
    'ipd_patients'            => 'IPD Member',
    'ipd_opd'                 => 'IPD/OPD',
    ...
    'vaccinated_patients'     => 'Vaccinated Members',
    'users'                   => 'Users',
    'front_settings'          => 'Front Settings',
    'front_service'           => 'Front Service',
    'about_us'                => 'About Us',
    'make_an_appointment'     => 'Make An Appointment',
    'patient_appointment'     => 'Member Appointment',
    'old_patient'             => 'Old Member',
    'new_patient'             => 'New Member',
    ...
    'hospital_schedules' => [
        'exists_doctor_schedule' => 'Some trainers have scheduled their days in given unchecked days, so are you sure you want to perform this operation?',
    ],
    ...
    'doctor_department'    => [
        'doctor_departments'        => 'Trainer Departments',
        'doctor_department'         => 'Trainer Department',
        'doctor_department_details' => 'Trainer Department Details',
        'new_doctor_department'     => 'New Trainer Department',
        'edit_doctor_department'    => 'Edit Trainer Department',
        'title'                     => 'Title',
        'description'               => 'Description',
    ],
    ...
    'investigation_report' => [
        ...
        'birth_date_validation'        => 'Investigation report date should not be smaller than member birth date.',
    ],
    ...
    'birth_report'         => [
        ...
        'date'                                               => 'Date',
        'description'                                        => 'Description',
        'data_should_not_be_smaller_than_patient_birth_date' => 'Date should not be smaller than member birth date.',
        'patient_birth_date_not_found'                       => 'Member Birth Date not found.',
    ],
    ...
    'patient'              => [
        'new_patient'        => 'New Member',
        'edit_patient'       => 'Edit Member',
        'patient_details'    => 'Member Details',
    ...
    'doctor'              => [
        'new_doctor'     => 'New Trainer',
        'edit_doctor'    => 'Edit Trainer',
        'doctor_details' => 'Trainer Details',
    ...
    'bed_assign'          => [
        ...
        'ipd_patient_id'                                            => 'IPD Member Id',
        'assign_date_should_not_be_smaller_than_patient_birth_date' => 'Assign date should not be smaller than member birth date.',
    ],
    ...
    'bill'                => [
        ...
        'patient_cell_no' => 'Member Cell No',
    ...
    'appointment'         => [
        ...
        'date'                                       => 'Date',
        'doctor_department'                          => 'Trainer Department',
        'doctor_department_name'                     => 'Trainer Department Name',
        'doctor'                                     => 'Trainer',
        'description'                                => 'Description',
        'patient'                                    => 'Member',
        ...
        'please_select_doctor_department'            => 'Please select Trainer Department',
        'please_select_doctor'                       => 'Please select Trainer',
        'doctor_schedule_not_available_on_this_date' => 'Trainer Schedule not available this date.',
    ...
    'patient_admission' => [
        'new_patient_admission'  => 'New Member Admission',
        'edit_patient_admission' => 'Edit Member Admission',
        'details'                => 'Member Admission Details',
        'patient'                => 'Member',
        'patient_name'           => 'Member Name',
        'doctor'                 => 'Trainer',
        'doctor_name'            => 'Trainer Name',
        ...
        'patient_admission_id'   => 'Member Admission Id',
    ],
    ...
    'setting' => [
        ...
        'hospital_from_day'  => 'Working Day',
        'hospital_from_time' => 'Working Time',
        'about_us'           => 'About Us',
    ...
    'schedule' => [
        ...
        'doctor_name'              => 'Trainer Name',
        'select_doctor_name'       => 'Select Trainer Name',
        'per_patient_time'         => 'Per Member Time',
    ...
    'doctor_opd_charge'  => [
        'new_doctor_opd_charge'  => 'New Trainer OPD Charge',
        'edit_doctor_opd_charge' => 'Edit Trainer OPD Charge',
        'doctor_name'            => 'Trainer Name',
        'standard_charge'        => 'Standard Charge',
        'doctor'                 => 'Trainer',
    ],
    ...
    'patient_diagnosis_test' => [
        ...
        'patient_diagnosis_test'         => 'Member Diagnosis Tests',
        'report_number'                  => 'Report number',
        'patient'                        => 'Member',
        'doctor'                         => 'Trainer',
        'created_at'                     => 'Created at',
        'action'                         => 'Action',
        'new_patient_diagnosis_test'     => 'New Member Diagnosis Test',
        'edit_patient_diagnosis_test'    => 'Edit Member Diagnosis Test',
        'create_patient_diagnosis_test'  => 'Create Member Diagnosis Test',
        'patient_diagnosis_test_details' => 'Member Diagnosis Test Details',
    ...
    'ipd_patient' => [
        'ipd_patient'                => 'IPD Member',
        'ipd_patients'               => 'IPD Members',
        'new_ipd_patient'            => 'New IPD Member',
        'edit_ipd_patient'           => 'Edit IPD Member',
        'ipd_patient_details'        => 'IPD Member Details',
        'patient_id'                 => 'Member',
        'ipd_number'                 => 'IPD No',
        'height'                     => 'Height',
        'weight'                     => 'Weight',
    ...
    'ipd_bill' => [
        ...
        'discharge_patient'      => 'Discharge Member',
    ],

    'opd_patient' => [
        'opd_patient'         => 'OPD Member',
        'opd_patients'        => 'OPD Member',
        'new_opd_patient'     => 'New OPD Member',
        'edit_opd_patient'    => 'Edit OPD Member',
        'opd_patient_details' => 'OPD Member Details',
        'opd_number'          => 'OPD No',
    ...
    'vaccinated_patient' => [
        ...
        'description'            => 'Description',
        'add_vaccinate_patient'  => 'Add Vaccinated Member',
        'new_vaccinate_patient'  => 'New Vaccinated Member',
        'edit_vaccinate_patient' => 'Edit Vaccinated Member',
        'vaccine'                => 'Vaccine',
        'vaccinate_patient'      => 'Vaccinate Member',
    ],
    ...
    'front_setting' => [
        ...
        'home_page_certified_doctor_image'       => 'Home Page Certified Trainer Image',
        'home_page_certified_doctor_text'        => 'Home Page Certified Trainer Text',
        'home_page_certified_doctor_title'       => 'Home Page Certified Trainer Title',
        'home_page_certified_doctor_description' => 'Home Page Certified Trainer Description',
    ...
    'web_home' => [
        ...
        'sign_up'                                            => 'Sign Up',
        'available_doctors'                                  => 'Available Trainers',
        'select_doctors'                                     => 'Select Trainers',
        'contact_doctors'                                    => 'Contact Trainers',
        'easy_solutions'                                     => 'Easy Solutions',
        '4_easy_step_and_get_the_world_best_treatment'       => '4 Easy Step and Get the Best Treatment',
        'book_an_appointment'                                => 'Book an Appointment',
        'select_doctor'                                      => 'Select Trainer',
        'book_now'                                           => 'Book Now',
        'patients_beds'                                      => 'Members',
        'doctors_nurses'                                     => 'Trainers',
        'happy_patients'                                     => 'Happy Members',
        'book_appointment'                                   => 'Book Appointment',
        'our_services'                                       => 'Our Services',
        'we_offer_different_services_to_improve_your_health' => 'We Offer Different Services To Improve Your Physical Health',
        'professional_doctors'                               => 'Professional Trainers',
        'we_are_experienced_healthcare_professionals'        => 'We are Experienced Healthcare Professionals',
        'our_testimonials'                                   => 'Our Testimonials',
        'what_our_patient_say_about_medical_treatments'      => 'What Our Members Say About Our Treatments',
    ],
